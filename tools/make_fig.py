#!/usr/bin/env python3
"""Effective bandwidth vs message size for four links, one log-log panel (attempt 6).
...
CURVES = {
    "Link A": [0.008, 0.03, 0.1, 0.5, 2, 8, 40, 50, 60, 80, 90],
    "Link B": [0.005, 0.02, 0.08, 0.3, 1, 3, 6, 7, 8, 8, 8],
    "Link C": [0.003, 0.01, 0.05, 0.2, 0.8, 4, 20, 40, 70, 60, 60],
    "Link D": [0.002, 0.008, 0.03, 0.1, 0.4, 2, 4, 6, 7, 7, 7],
}
